...
<html lang="en">
  ...
  <body>
    ...
    <main>
        <h1>Primeros paso con Dcker</h1>
        <p class="fs-5 col-md-8">Configuraremos contenedores Docker para correr un servidor apache, junto a php, mysql, mongoDB y memcached.</p>

        <hr class="col-3 col-md-2 mb-5">

        <h1>Control de Memcached</h1>
        ...
        <div class="col-md-6">
            ...
            <li class="d-flex align-items-start mb-1"><a href="http://localhost:8081/" rel="noopener" target="_blank">Mongo Express</a></li>
            <li class="d-flex align-items-start mb-1">u:mexpress p:mexpress</li>
            <li class="d-flex align-items-start mb-1"><a href="http://localhost:8085/index.php" rel="noopener" target="_blank">phpMyAdmin</a></li>
            <li class="d-flex align-items-start mb-1">u:root p:admin</li>
            <li class="text-muted d-flex align-items-start mb-1">Bootstrap Parcel starter (coming soon!)</li>
            <li class="d-flex align-items-start mb-1"><a href="http://localhost/mysql.php" rel="noopener" target="_blank">Probar conexion con MySql</a></li>
            </ul>
        </div>
        ...
        <div class="col-md-6">
            ...
            <ul class="icon-list ps-0">
            <li class="d-flex align-items-start mb-1">apache</li>
            <li class="d-flex align-items-start mb-1">php</li>
            <li class="d-flex align-items-start mb-1">mysql</li>
            <li class="d-flex align-items-start mb-1">phpMyAdmin</li>
            <li class="d-flex align-items-start mb-1">mongo</li>
            <li class="d-flex align-items-start mb-1">mongo-express</li>
            </ul>
        </div>
        </div>
    </main>
